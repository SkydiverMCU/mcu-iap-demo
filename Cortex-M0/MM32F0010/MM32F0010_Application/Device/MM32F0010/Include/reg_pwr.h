...
#define PWR_CR_STDBY_FS_WK              (0x03U  << PWR_CR_STDBY_FS_WK_Pos)      ///< Fast wake up period in STANDBY mode
#define PWR_CR_STDBY_FS_WK_9            (0x00U  << PWR_CR_STDBY_FS_WK_Pos)      ///< 9 LSI cycles 
#define PWR_CR_STDBY_FS_WK_7            (0x01U  << PWR_CR_STDBY_FS_WK_Pos)      ///< 7 LSI cycles
#define PWR_CR_STDBY_FS_WK_5            (0x02U  << PWR_CR_STDBY_FS_WK_Pos)      ///< 5 LSI cycles
#define PWR_CR_STDBY_FS_WK_2            (0x03U  << PWR_CR_STDBY_FS_WK_Pos)      ///< 2 LSI cycles
