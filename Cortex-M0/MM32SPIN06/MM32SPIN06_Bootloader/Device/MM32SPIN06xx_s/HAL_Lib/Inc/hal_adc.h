...
typedef enum {
    ...
    ADC_Samctl_8_5   = ADC_CFGR_SAMCTL_8_5,   ///< ADC sample time select 8.5t
    ...
    ADC_Samctl_42_5  = ADC_CFGR_SAMCTL_42_5,  ///< ADC sample time select 42.5t
...
void ADC_RegularChannelConfig(ADC_TypeDef* adc, ADCCHANNEL_TypeDef channel, u8 rank, u32 sample_time);//ADCSAM_TypeDef
