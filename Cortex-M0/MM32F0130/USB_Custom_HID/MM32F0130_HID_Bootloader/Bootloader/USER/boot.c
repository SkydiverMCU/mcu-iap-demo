...
const uint8_t Report_Return_Err[64] = {0xD5, 0x04, 0x00, 0x00, 0x59};
const uint8_t Valid_buf[4] = {0x55, 0xAA, 0xAA, 0x55};
// const uint8_t unValid_buf[4]={0xff,0xff,0xff,0xff};
