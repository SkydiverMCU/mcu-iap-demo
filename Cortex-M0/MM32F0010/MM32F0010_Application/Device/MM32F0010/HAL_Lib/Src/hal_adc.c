...
/**
  * @brief  Configure ADC Channel x sample time.
  * @param  adc:  select the ADC peripheral.
  * @param  sample_time: the ADC Channel x Sample time to configure.
  * @retval None.
  */
void ADC_SampleTimeConfig(ADC_TypeDef *adc, u32 sample_time) //ADCSAM_TypeDef
{
