...
void USB_RCC_Config(void)
{
    RCC->CFGR &= ~(0x03 << 22);
    RCC->CFGR |= (0x00 << 22); //whne pll 96M
}
////////////////////////////////////////////////////////////////////////////////
...
void USB_GPIO_Config(void)
{
    ...
    RCC_APB1PeriphClockCmd(RCC_APB1ENR_USB, ENABLE);             //USB CLK EN
    
    RCC_APB1PeriphResetCmd(RCC_APB1ENR_USB,ENABLE);
    RCC_APB1PeriphResetCmd(RCC_APB1ENR_USB,DISABLE);
...
void UART_GPIO_Config(void)
{
    ...
    RCC_AHBPeriphClockCmd( RCC_AHBENR_GPIOA, ENABLE );
    RCC_APB2PeriphClockCmd(RCC_APB2ENR_UART1, ENABLE);            //USB CLK EN
...
bool UART_Config(void)
{
    ...
    switch (linecoding.format) {
        case 0:
            ...
            break;
        case 1:
            UART_InitStruct.UART_StopBits = UART_StopBits_1;//1.5old
            break;
        case 2:
