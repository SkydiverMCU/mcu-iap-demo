...
#define EXTI_Line17     ((u32)0x0020000)                                        ///< External interrupt line 17 Connected to the IWDG interrupt
...
#define EXTI_MemoryRemap_Flash                (0x00U)
#define EXTI_MemoryRemap_SystemMemory         (0x01U)
#define EXTI_MemoryRemap_SRAM                 (0x03U)
