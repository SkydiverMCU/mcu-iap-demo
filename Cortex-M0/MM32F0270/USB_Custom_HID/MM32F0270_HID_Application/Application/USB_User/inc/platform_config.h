...
#define RCC_AHBENR_GPIO_DISCONNECT      RCC_AHBENR_GPIOA

#define RCC_AHBENR_GPIO_KEY             RCC_AHBENR_GPIOC
#define RCC_AHBENR_GPIO_TAMPER          RCC_AHBENR_GPIOA
#define RCC_AHBENR_GPIO_IOAIN           RCC_AHBENR_GPIOA
#define RCC_AHBENR_GPIO_LED             RCC_AHBENR_GPIOA|RCC_AHBENR_GPIOD
